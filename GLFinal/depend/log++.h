...
namespace logpp
{
	...
	public:
		...
		static void assert(bool condition, std::string text, Color clr = Color::LIGHTRED);
		/*Prints a light red error message*/
		static void error(std::string text, Color clr = Color::LIGHTRED);
		/*Prints a light green debug message.*/
		static void debug(std::string text, Color clr = Color::LIGHTGREEN);
		/*Prints a yellow warning message*/
		static void warning(std::string text, Color clr = Color::YELLOW);
		/*Prints a white log message*/
		static void log(std::string text, Color clr = defaultColor);
